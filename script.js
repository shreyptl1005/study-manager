...
function initAuthGate() {
  ...
  authUnsubscribe = firebase.auth().onAuthStateChanged(handleAuthStateChange);
}
...
function wireEvents() {
  ...
  document.getElementById('googleSignInBtn').addEventListener('click', () => {
    if (typeof firebase === 'undefined' || !firebase.auth) { showToast('Firebase load nathi thayu.'); return; }
